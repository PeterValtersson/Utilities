...
struct ProfilerNode {
	...
	ProfilerNode(ProfilerNode* parent, const char* functionName, uint64_t myHash, const char* file)
	...
	std::map<uint64_t, ProfilerNode*> children;
...
#define StartProfile Prolifer pl(Profiler::GetInstance()); pl.p.startProfile<__FUNCTION__> (Basename::functionName(__FUNCTION__), Basename::fileName( __FILE__));
